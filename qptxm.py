...
apply_best = True
  .type = bool
  .help = "Apply at most one modification to each residue in the best conformation."
  .help = "For visualization it may be helpful to turn this off and see all options."
prune = True
  .type = bool
